...
class databasemongo {
    /** @var \BUSaragon\common\databasemongo[] $_singleton database object */
    private static $_singleton = [];
    const DATABASE_ID = 'mongodb';

    /**
     * @var array|null|\BUSaragon\common\databasemongo[] $_databases database object array like:
     * <br/>
     *      - id: database id
     ...
     * @return \BUSaragon\common\databasemongo Objeto controlador de base de datos
     */
