...
class modeldestinations extends \BUSaragon\common\model {
    public $_database_collection = 'cities_destination';
    public $code = -1;
    public $code_origin = -1;
    public $destination = '';
    public $network = -1;
    ...
    public function update_from_api( $api_object, $api_endpoint ) {
        ...
        if ( $api_endpoint === \BUSaragon\common\controller::ENDOPOINT_BUS_CITIES_DESTINATION_CTAZ ) {
            ...
            $this->code_origin = $api_object->origin_id;
            $this->destination = $api_object->destination;
